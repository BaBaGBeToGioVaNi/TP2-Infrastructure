...
router bgp 121
address-family ipv4
neighbor 100.101.2.2 remote-as 101
neighbor 100.101.2.2 description eBGP with NREN1 (AS101)
neighbor 100.101.2.2 password NSRC-BGP
neighbor 100.101.2.2 activate
!
address-family ipv6
neighbor 2001:11:0:20::1 remote-as 101
neighbor 2001:11:0:20::1 description eBGP with NREN1 (AS101)
neighbor 2001:11:0:20::1 password NSRC-BGP
neighbor 2001:11:0:20::1 activate
!
```